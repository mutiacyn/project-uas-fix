                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="p-5">
                                        ...
                                        <!-- Form -->
                                        <form action="{{ route('karyawan.update', $karyawan->karyawan_id) }}" method="POST"
                                            class="user">
                                            @csrf
                                            @method('PUT')
                                                ...
                                                <select name="user_id" class="form-control" required>
                                                    ...
                                                    @foreach ($users as $user)
                                                        <option value="{{ $user->id }}"
                                                            {{ old('user_id', $karyawan->user_id) == $user->id ? 'selected' : '' }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="birthday" name="birthday" class="form-control"
                                                    value="{{ old('birthday', $karyawan->birthday) }}" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="gender" id="gender" class="form-control" required>
                                                    <option value="" disabled selected>Pilih</option>
                                                    <option value="Male"
                                                        {{ old('gender', $karyawan->gender) == 'Male' ? 'selected' : '' }}>
                                                        Male</option>
                                                    <option value="Female"
                                                        {{ old('gender', $karyawan->gender) == 'Female' ? 'selected' : '' }}>
                                                        Female</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="alamat" id="alamat" class="form-control" rows="3" placeholder="Masukkan Alamat">{{ old('alamat', $karyawan->alamat) }}</textarea>
                                            </div>
